...
public class ShoppingListWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        CharSequence widgetText = ShoppingListWidgetConfigureActivity.loadTitlePref(context, appWidgetId);
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ShoppingListWidgetConfigureActivity.deleteTitlePref(context, appWidgetId);
        }
    }
